"""Scene 15: a separate closing subscribe card."""
...
class Scene_15_Subscribe(Scene):
...
def play_scene(scene: Scene) -> None:
    scene_start = begin_scene(scene, "15")
    ...
    tagline = VGroup(
        ...
        Text("Keep following physics, chemistry and mathematics.", font_size=34, color=cfg.WHITE, weight=BOLD),
    ...
    narration_wait(scene, 10.8)
    end_scene(scene, scene_start, cfg.SCENE_DURATIONS["15"])
