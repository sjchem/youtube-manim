"""Project-wide settings for Visual Calculus Part 1: From Limits to Derivatives."""
...
PROJECT_TITLE = "Visual Calculus: From Limits to Derivatives"
PROJECT_PART = "Part 1"
PROJECT_SLUG = "visual-calculus-limits-derivatives-part1"
SERIES_LABEL = "Visualized Mathematics"
VIDEO_SUBTITLE = "What does it mean to change, right now?"
...
# Part 1 total: 1068 seconds = 17:48. Calibrated against narration_script.md
