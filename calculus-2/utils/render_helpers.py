"""Safe-frame and pacing helpers for mobile-readable compositions."""
...
def rectangle_count_sequence(levels: tuple[int, ...] = (4, 10, 50, 200)) -> tuple[int, ...]:
    """The Riemann-rectangle counts used to build the sum-to-integral reveal."""
    return levels
