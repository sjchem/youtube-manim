"""Small CLI for listing and rendering the World Cup Magnus effect scenes."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Render the World Cup Magnus effect Manim project.")
    ...
    preview.add_argument("scene", nargs="?", default="01", help="Scene key: 01-09 or full.")
    ...
    render.add_argument("scene", help="Scene key: 01-09 or full.")
...
def main() -> int:
    ...
    if args.command == "list":
        for key, scene_file, scene_class in list_scenes():
            print(f"{key:>4}  {scene_class:<34} {scene_file}")
        return 0
