"""Scene 17: a separate closing subscribe card."""
...
def play_scene(scene: Scene) -> None:
    scene_start = begin_scene(scene, "17")
    ...
    tagline = VGroup(
        ...
        Text(
            "Keep following the physics and mathematics.",
            font_size=34,
            color=cfg.WHITE,
            weight=BOLD,
        ),
    ...
    end_scene(scene, scene_start, cfg.SCENE_DURATIONS["17"], fade_background=True)
