"""Small CLI for listing and rendering Chapter 2 scenes."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Render the Chapter 2 population/sample Manim project.")
    ...
    preview.add_argument("scene", nargs="?", default="01", help="Scene key: 01-11 or full.")
    ...
    render.add_argument("scene", help="Scene key: 01-11 or full.")
