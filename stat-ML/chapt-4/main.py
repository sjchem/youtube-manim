"""Small CLI for listing and rendering Chapter 4 scenes."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Render the Chapter 4 probability-basics Manim project.")
    ...
    preview.add_argument("scene", nargs="?", default="01", help="Scene key: 01-10 or full.")
    ...
    render.add_argument("scene", help="Scene key: 01-10 or full.")
...
def main() -> int:
    ...
    if args.command == "list":
        for key, scene_file, scene_class in list_scenes():
            print(f"{key:>4}  {scene_class:<32} {scene_file}")
        return 0
