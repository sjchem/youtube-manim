"""Project-wide visual and render settings for Chapter 3."""
...
PROJECT_TITLE = "Mean, Median, Variance & Standard Deviation for ML"
PROJECT_SUBTITLE = "Statistics for ML - Part 1, Chapter 3"
