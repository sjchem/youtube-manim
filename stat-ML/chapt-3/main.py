"""Small CLI for listing and rendering Chapter 3 scenes."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Render the Chapter 3 descriptive statistics Manim project.")
    ...
    preview.add_argument("scene", nargs="?", default="01", help="Scene key: 01-12 or full.")
    ...
    render.add_argument("scene", help="Scene key: 01-12 or full.")
