"""Scene 12 - closing subscribe card."""
...
def play_scene(scene: Scene) -> None:
    scene_start = begin_scene(scene, "12")
    ...
    tagline = VGroup(
        ...
        Text("Keep following the data before the model.", font_size=34, color=cfg.WHITE, weight=BOLD),
