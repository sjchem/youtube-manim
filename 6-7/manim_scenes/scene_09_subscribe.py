...
from manim_scenes.common import begin_scene, end_scene, label, narration_wait, paced_play
...
def play_scene_09(scene: Scene) -> None:
    ...
    tagline = VGroup(
        ...
        Text("Keep following the mathematics.", font_size=34, color=cfg.WHITE, weight=BOLD),
    ...
    end_scene(scene, scene_start, 0.5)
