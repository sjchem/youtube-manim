...
from manim_scenes.common import add_cinematic_background, begin_scene, end_scene, narration_wait, paced_play
...
def play_scene(scene: Scene) -> None:
    ...
    paced_play(scene, Indicate(subscribe, color=cfg.WHITE, scale_factor=1.04), run_time=0.9)
